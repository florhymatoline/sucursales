...
$q = "UPDATE sucursales SET sucursal='$sucursalEdit',localizacion='$localizacion',capacidad_max='$capacidad_max',encargado='$encargado',id_user='$id_user' WHERE id_sucursal = '$id_sucursal'";
